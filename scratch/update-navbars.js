...
// Old desktop nav links pattern (the 3 links: Herramientas, Calc. ISR, Guía de Uso)
...
htmlFiles.forEach(file => {
    ...
    if (content.includes('herramientas-calculadoras.html" class="text-gray-600 hover:text-brand-blue font-medium transition-colors border-b-2')) {
        content = content.replace(oldDesktopNav, newDesktopNav);
        changed = true;
    }
    
    if (content.includes('herramientas-calculadoras.html" class="block px-3 py-2 rounded-md text-base font-medium text-gray-700')) {
